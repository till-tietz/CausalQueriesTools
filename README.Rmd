...
```{r, echo = FALSE, fig.width=6, fig.height=6, fig.align='center', out.height='40%', out.width='40%', fig.asp=0.8}
...
```{r, echo = FALSE, fig.width=6, fig.height=4, fig.align='center', out.height='40%', out.width='40%', fig.asp=0.8}
...
```{r, echo = FALSE, fig.width=7, fig.height=8, fig.align='center', out.height='55%', out.width='50%', fig.asp=0.8, message=FALSE, warning= FALSE}
